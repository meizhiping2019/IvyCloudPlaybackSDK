...
public class CloudVideoView extends PlayerView {
    ...
    public CloudVideoView(Context context, AttributeSet attrs) {
    ...
    public CloudVideoView(Context context, AttributeSet attrs, int defStyle) {
